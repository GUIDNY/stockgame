...
const lessons = [
  ...
  // ═══ LESSON 14: SMC - מבנה שוק חכם ═══════════════════════════════════════════
  {
    ...
    slides: [
      ...
      { title:'Fair Value Gap (FVG)', body:'FVG = פער במחיר שלא נטופל.\n\nנניח המחיר יצא מ-100 ל-105 בקפיצה חדה.\nפער זה (100-105) נשאר ״פתוח״ — זה ה-FVG!\n\nהמחיר בדרך כלל חוזר למלא פערים אלו.',
        keyPoints:['FVG = פערים לא מטופלים','המחיר "זוכר" פערים','פערים = אזורי ספיגה','אפשר לסחור על ״מילוי״ פערים'],
        visual:{ candles:buildCandles([{o:100,c:100},{o:100,c:105,wu:2.5},{o:105,c:107},{o:107,c:104},{o:104,c:100,wd:3.5}]), overlays:[{type:'fvg',priceHigh:105,priceLow:100,color:'#3fb950',label:'FVG פתוח'},{type:'arrow',idx:4,text:'חזרה למלא את הפער',color:'#3fb950',position:'bottom'}], caption:'FVG המחכה - המחיר תמיד חוזר למלא את הפערים' }},
  ...
  // ═══ LESSON 16: SMC - Internal Liquidity ═══════════════════════════════════════
  {
    ...
    slides: [
      ...
      { title:'משמעות ההתנגדות הפנימית', body:'כאשר המחיר חוזר ל-Internal Liquidity:\n\n1. אם ספוג — סוחרים קטנים הוצאו\n2. אם פריצה — momentum חזק\n3. אם retrace — הסוד הבא מתחיל\n\nInternal Liquidity = נקודת חידוש בתוך התנודה.',
        keyPoints:['Internal = התאמה בתנודה','חזרה ל-Internal = בדיקת סיעור','רמה זו מוגנת יותר משאר','סוחרים קטנים לא מצפים לה'],
        visual:{ candles:buildCandles([{o:100,c:108},{o:108,c:112,wu:2},{o:112,c:109},{o:109,c:115,wu:1.5},{o:115,c:110,wd:2.5},{o:110,c:113}]), overlays:[{type:'fvg',priceHigh:112,priceLow:109,color:'#9333ea',label:'Internal FVG'},{type:'arrow',idx:3,text:'חזרה לInternal',color:'#3fb950',position:'bottom'},{type:'arrow',idx:5,text:'עלייה חדשה',color:'#3fb950',position:'top'}], caption:'Internal FVG — פער בתוך התנודה' }},
      ...
      { title:'איך זה עובד בשוק?', body:'סוחרים קטנים שמים Stop Loss על High הראשי (115).\n\nכסף גדול יודע זאת.\nהוא מטרף את ה-Internal High (113) תחילה.\nסוחרים קטנים לא רואים, ממשיכים.\nכסף גדול נכנס ברציניות בכיוון החדש.',
        keyPoints:['Liquidity Pyramids = יירוטים בשכבות','סוחרים קטנים חושבים בHigh אחד','כסף גדול חושב בשכבות','המשחק = יירוט שכבתי'],
        visual:{ candles:buildCandles([{o:100,c:110},{o:110,c:115,wu:2},{o:115,c:108},{o:108,c:105},{o:105,c:110},{o:110,c:118,wu:2.5}]), overlays:[{type:'fvg',priceHigh:115,priceLow:113,color:'#f85149',label:'High FVG'},{type:'fvg',priceHigh:113,priceLow:110,color:'#9333ea',label:'Internal FVG'},{type:'arrow',idx:5,text:'טרנד חדש בכיוון אחר',color:'#3fb950',position:'top'}], caption:'יירוטי כסף חכם בשכבות FVG' }},
      { title:'Internal Liquidity בפרקטיקה', body:'כדי לזהות Internal Liquidity:\n\n1. צפה בתנודה בעלת טווח גדול\n2. מצא High/Low משניים בדרך\n3. תייג אותן (אל תעשה עסקה בכל)\n4. חכה שהמחיר יחזור\n5. כנס עם Risk Management חזק\n\nזה דורש תרגול ותבונה חזקה.',
        ...
        visual:{ candles:buildCandles([{o:100,c:110},{o:110,c:115},{o:115,c:105},{o:105,c:112,wu:1.8},{o:112,c:108},{o:108,c:114},{o:114,c:120,wu:2}]), overlays:[{type:'fvg',priceHigh:115,priceLow:105,color:'#f85149',label:'Main FVG'},{type:'fvg',priceHigh:112,priceLow:108,color:'#9333ea',label:'Internal FVG'}], caption:'SMC Internal Liquidity - FVG בשכבות' }},
    ],
  },
];

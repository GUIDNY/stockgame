...
{
    /// <summary>Runtime uGUI helpers. Every panel carries an Image so fully transparent overlays still exist.</summary>
    public static class UIFactory
    {
        public static readonly Color Bg = new Color(0.05f, 0.06f, 0.1f, 0.88f);
        public static readonly Color Accent = new Color(1f, 0.78f, 0.15f);
        public static readonly Color AccentRed = new Color(1f, 0.3f, 0.25f);
        public static readonly Color TextColor = new Color(0.96f, 0.96f, 0.96f);
        ...
        public static readonly Color ButtonSelected = new Color(0.85f, 0.6f, 0.1f, 1f);
        ...
        {
            var bg = Panel(parent, "Bar", back, Vector2.zero, Vector2.one, Vector2.zero, Vector2.zero);
            var fill = Panel(bg, "Fill", color, Vector2.zero, new Vector2(1, 1), Vector2.zero, Vector2.zero);
        ...
        {
            ((RectTransform)fill.transform).anchorMax = new Vector2(Mathf.Clamp01(fraction), 1f);
        }

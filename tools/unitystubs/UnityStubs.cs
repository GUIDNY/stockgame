...
namespace UnityEngine
{
    ...
    public struct Vector3
    {
        ...
        public static float SignedAngle(Vector3 a, Vector3 b, Vector3 axis) => 0; public static Vector3 ClampMagnitude(Vector3 v, float m) => v; public static Vector3 SmoothDamp(Vector3 c, Vector3 t, ref Vector3 v, float s) => c;
    }
    ...
    public enum KeyCode { None, Space, Escape, R, J, K, L, Q }
    public static class Input { public static float GetAxis(string n) => 0; public static float GetAxisRaw(string n) => 0; public static bool GetKey(KeyCode k) => false; public static bool GetKeyDown(KeyCode k) => false; public static bool GetKeyUp(KeyCode k) => false; }
    ...
    public enum HumanBodyBones { Hips, RightFoot, LeftFoot }
    ...
    public class Animator : Behaviour { public RuntimeAnimatorController runtimeAnimatorController { get; set; } public bool applyRootMotion { get; set; } public AnimatorCullingMode cullingMode { get; set; } public void SetFloat(string n, float v) { } public void SetFloat(string n, float v, float damp, float dt) { } public void SetBool(string n, bool v) { } public void SetTrigger(string n) { } public Transform GetBoneTransform(HumanBodyBones b) => null; public void SetIKPositionWeight(AvatarIKGoal g, float w) { } public void SetIKPosition(AvatarIKGoal g, Vector3 p) { } public void SetIKRotationWeight(AvatarIKGoal g, float w) { } public void SetIKRotation(AvatarIKGoal g, Quaternion r) { } }
    ...
    public class AudioSource : Behaviour { public AudioClip clip { get; set; } public bool loop { get; set; } public bool playOnAwake { get; set; } public float spatialBlend { get; set; } public float minDistance { get; set; } public float maxDistance { get; set; } public AudioRolloffMode rolloffMode { get; set; } public float volume { get; set; } public float pitch { get; set; } public void Play() { } public void Stop() { } public void PlayOneShot(AudioClip c, float v) { } }
